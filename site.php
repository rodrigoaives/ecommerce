...
$app->get("/profile", function() {
	...
	// O parametro false é para indicar que nao eh admin
	User::verifyLogin(false);
...
$app->post("/profile/change-password", function() {
	...
	if ($_POST['current_pass'] === $_POST['new_pass']) {
		...
		User::setMsgError("Sua nova senha deve ser diferente da senha atual.");
		header("Location: /profile/change-password");
		exit;
	...
	if ($_POST['new_pass'] != $_POST['new_pass_confirm']) {
		...
		User::setMsgError("Os campos: 'nova senha' e 'confirme a nova senha' não coincidem.");
		header("Location: /profile/change-password");
		exit;
	...
	if(!password_verify($_POST['current_pass'], $user->getdespassword())) {
		...
		User::setMsgError("A senha atual informada é inválida.");
		header("Location: /profile/change-password");
		exit;
